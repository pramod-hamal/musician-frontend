...
import useAddArtist from "../../hook/useAddArtist";

interface AddUserModalProps {
  closeModal: () => void;
}

export default function AddArtistForm({ closeModal }: AddUserModalProps) {
  const { formik, isLoading } = useAddArtist(closeModal);
